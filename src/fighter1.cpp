...
struct Martialarchetype{
	...
	enum BMmaneuvers{
			...
			evasivefootwork = "(When you move, you can expend one superiority die, rolling the die and adding the number rolled to your AC until you stop moving.)",
			feintingattack = "(You can expend one superiority die and us a bonus action on your turn to feint, choosing one creature within 5 feet of you as your target. you have advantage on your next attack roll against that creature. if that attack hits, add the superiority die to the attack's damage roll.)",
			goadingattack = "()",
			lungingattack = "()",
			maneuveringattack = "()",
			menacingattack = "()",
